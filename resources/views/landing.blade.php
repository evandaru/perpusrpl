            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white">Selamat datang di E perpus 👋🏻</h1>
                        <p class="lead mb-4 text-white opacity-8">kami menyediakan berbagai buku yang keren😎</p>
                        <a href="/login">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-md-6">
                                <div class="info">
                                    ...
                                    <h5>Membaca Semakin Mudah</h5>
                                    <p>Baca buku, Berbagi koleksi bacaan dan bersosialisasi secara bersamaan. Dimana
                                        pun,Kapanpun dengan nyaman bersama setiap orang.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info">
                                    <i class="material-icons text-3xl text-gradient text-info mb-3">payments</i>
                                    <h5>Syarat Pendaftaran Mudah</h5>
                                    <p>Cukup beberapa detik untuk bisa bergabung dan merasakan aplikasi e-perpus.</p>
                                </div>
                            </div>
                        </div>
                        <div class="row justify-content-start mt-4">
                            <div class="col-md-6">
                                <div class="info">
                                    ...
                                    <h5>Buat dan Sebarkan Kutipanmu</h5>
                            ...
                            <div class="col-md-6">
                                <div class="info">
                                    ...
                                    <h5>Berbagi dan Bersosialisasi</h5>
                                    <p>Temukan, Jalin pertemanan, dan Dapatkan aktifitas lainnya.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <h5 class="font-weight-normal">
                                    <a href="javascript:;">Jadilah Pribadi yang Kreatif dan Inovatif</a>
                                </h5>
                                <p class="mb-0">
                                    Dimanapun kamu berada e-perpus selalu hadir untuk menghubungkan dan merekomendasikan
                                    buku favoritmu kepada teman dan sahabatmu.
                                </p>
