                            ...
                            <div class="card card-plain">
                                <div class="card-header p-0 position-relative">
                                    <a class="d-block blur-shadow-image">
                                        <img src="img/buku/{{ $bukus->gambar_buku }}.jpg" alt="img-blur-shadow"
                                ...
                                <div class="card-body px-0">
                                    <h5>
                                        <a href="javascript:;"
                                            class="text-dark font-weight-bold">{{ $bukus->nama_buku }}</a>
                                    </h5>
                                    <p>

                                        pengarang : {{ $bukus->pengarang_buku }}
                                        <br>
                                        Penerbit : {{ $bukus->penerbit_buku }}
                                        <br>
                                        ISBN : {{ $bukus->isbn }}

                                    </p>
                                    <a href="/pinjam/{{ $bukus->id }}/{{ $bukus->nama_buku }}/{{ $bukus->gambar_buku }}/{{ $bukus->penerbit_buku }}/{{ $bukus->pengarang_buku }}/{{ $bukus->isbn }}/tambah"
                                        class="text-info text-sm icon-move-right">pinjam sekarang
